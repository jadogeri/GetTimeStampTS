...
1 Navigate to driectory using command `cd node_modules/@josephadogeridev/get-timestamp-ts`.
...
1 In the root of package type `npm run build` to generate build (dist) for production. 
